      ...
      home: Container(
        ...
        child: ListView(
          children: [
            ...
            _buildCard('LoginPageDesign', Container(height: 400, decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.grey)), clipBehavior: Clip.antiAlias, child: LoginPageDesign())),
            _buildCard('SplashPageDesign', Container(height: 400, decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.grey)), clipBehavior: Clip.antiAlias, child: SplashPageDesign())),
          ],
        ),
      ),
    );
